...
$(STATIC_OUTDIR)/nvm_library: | $(STATIC_OUTDIR)
	mkdir $@
...
$(SHARED_OUTDIR)/nvm_library: | $(SHARED_OUTDIR)
	mkdir $@
...
$(DEVICE_OUTDIR)/nvm_library: | $(DEVICE_OUTDIR)
	mkdir $@
...
$(SIMULATOR_OUTDIR)/nvm_library: | $(SIMULATOR_OUTDIR)
	mkdir $@
...
$(STATIC_OUTDIR)/nvm_test:nvm_library/nvm_test.cc $(STATIC_LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) $(CXXFLAGS) nvm_library/nvm_test.cc $(STATIC_LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)
