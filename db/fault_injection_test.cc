...
//    s = env->NewWritableFile(tmp_name, &tmp_file);
    s = env->NewWritableNVMFile(tmp_name, &tmp_file);
    if (s.ok()) {
...
class FaultInjectionTestEnv : public EnvWrapper {
 public:
  ...
  virtual NVM_Library* NVM_Env() { return nullptr; }
...
Status FaultInjectionTestEnv::NewWritableNVMFile(const std::string& fname,
                                              WritableFile** result) {
...
Status FaultInjectionTestEnv::NewAppendableNVMFile(const std::string& fname,
                                                WritableFile** result) {
